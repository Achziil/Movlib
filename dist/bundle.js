...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;function _get() {
...
/* harmony export */ });
/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(236);
/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(198);
...
var runtime = __webpack_require__(445);
...
// EXTERNAL MODULE: ./src/script/component/sidebar.js
var sidebar = __webpack_require__(262);
// EXTERNAL MODULE: ./node_modules/jquery/dist/jquery.js
var jquery = __webpack_require__(456);
var jquery_default = /*#__PURE__*/__webpack_require__.n(jquery);
// EXTERNAL MODULE: ./node_modules/sweetalert2/dist/sweetalert2.all.js
var sweetalert2_all = __webpack_require__(321);
var sweetalert2_all_default = /*#__PURE__*/__webpack_require__.n(sweetalert2_all);
;// CONCATENATED MODULE: ./src/script/data/data-source.js
function _classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
...
var MovieSource = /*#__PURE__*/function () {
  ...
  _createClass(MovieSource, null, [{
    key: "searchMovies",
    value: function searchMovies(keyword) {
      return fetch("https://api.themoviedb.org/3/search/movie?api_key=c721d2ddf5e72845a3691e3321764a2f&query=".concat(keyword)).then(function (response) {
...
/* harmony default export */ const data_source = (MovieSource);
...
var main = function main() {
  var api_key = "api_key=c721d2ddf5e72845a3691e3321764a2f";
  var base_url = "https://api.themoviedb.org/3";
  var api_url = base_url + "/movie/now_playing?" + api_key;
  var img_url = "https://image.tmdb.org/t/p/w500";
  var search_url = base_url + "/search/movie?" + api_key;
  var topRated_url = "/movie/top_rated?";
  var upcoming_url = "/movie/upcoming?";
  var popular_url = "/movie/popular?";
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              e.preventDefault();
              seacrhTerm = search.value;
              _context.next = 5;
              return data_source.searchMovies(seacrhTerm);

            case 5:
              data = _context.sent;
              showMovies(data); // getMovies(search_url + "&query=" + seacrhTerm);
            ...
            case 9:
              ...
              sweetalert2_all_default().fire("The Data?", "That thing is still around?", "question");
  ...
  function showMovies(data) {
    ...
    data.forEach(function (movie) {
      ...
      movieElement.innerHTML = "\n      <img src=\"".concat(img_url + poster_path, "\" alt=\"").concat(title, "\" class=\"movie-picture\" />\n      <div class=\"movie-info\">\n         <h2 class=\"movie-title\">").concat(title, "</h2>\n         <span class=\"").concat(getColor(vote_average), "\">").concat(vote_average, "</span>\n      </div>\n      <div class=\"overview\">\n         <h3>Sinopsis</h3>\n         <p>").concat(overview, "</p>\n      </div>\n      ");
  ...
  jquery_default()(".toprated").on("click", function (e) {
    e.preventDefault();
    getMovies(base_url + topRated_url + api_key);
  });
  jquery_default()(".upcoming-movies").on("click", function (e) {
    e.preventDefault();
    getMovies(base_url + upcoming_url + api_key);
  });
  jquery_default()(".popular-movies").on("click", function (e) {
    e.preventDefault();
